export default function PrivacyPolicy() {
  return (
    <div className="confidentiality-rules">
      ...
      <p>
        ...
        document outlines our confidentiality rules, emphasizing our commitment
        to not storing any user data on our servers.
      </p>
      ...
      <p>
        ...
        seriously. All communications between the app and OSM are conducted over
        secure channels to protect the integrity of the data being transmitted.
      </p>
      ...
      <p>
        We may update these confidentiality rules periodically. Any changes will
        be posted on this page, and we encourage you to review it to stay
